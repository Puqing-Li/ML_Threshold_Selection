...
def main():
    ...
    parser.add_argument(
        '--config',
        type=Path,
        default=ROOT / 'data' / 'examples' / 'expert_thresholds.csv',
    )
    parser.add_argument('--training-data', type=Path, default=ROOT / 'data' / 'training')
    parser.add_argument(
        '--test-data',
        type=Path,
        default=ROOT / 'data' / 'examples' / 'Quantity_LE01.xlsx',
    )
    parser.add_argument('--sample-id', default='LE01')
    parser.add_argument('--voxel-size-mm', type=float, default=0.03)
    parser.add_argument('--model-dir', type=Path, default=ROOT / 'data' / 'released_model',
